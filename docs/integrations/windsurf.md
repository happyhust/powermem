...
Connect Windsurf to PowerMem through the config generated by the [PowerMem VS Code extension](../../apps/vscode-extension/). The extension writes `~/.windsurf/context/powermem.json`.
...
The agent follows [`../../apps/vscode-extension/SETUP.md`](../../apps/vscode-extension/SETUP.md), prefers a reusable `powermem-server` HTTP API backend, and updates Windsurf's config only when Windsurf is the current target.
